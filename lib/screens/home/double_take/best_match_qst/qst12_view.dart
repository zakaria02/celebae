...
import 'qst13_view.dart';

class Question12View extends StatefulWidget {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  Question12View({this.profile, this.listBestMatchQuestion});
  @override
  State<StatefulWidget> createState() {
    return _Question12ViewState(
      profile: profile,
...
class _Question12ViewState extends State<Question12View> {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  _Question12ViewState({this.profile, this.listBestMatchQuestion});
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    AutoSizeText(
                      "Would you cast a blank vote in an election?",
                      style: TextStyle(
                        fontFamily: "Poppins",
                        fontSize: 25,
                      ...
                      onPressed: () {
                        ...
                        if (_answered && changed > 0 && _answers.length > 0) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (BuildContext context) => Question13View(
                                profile: profile,
                                listBestMatchQuestion: listBestMatchQuestion,
                              ),
                            ),
