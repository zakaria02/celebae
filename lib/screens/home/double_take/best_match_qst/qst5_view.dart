...
class _Question5ViewState extends State<Question5View> {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  _Question5ViewState({this.profile, this.listBestMatchQuestion});
                      ...
                      onPressed: () {
                        ...
                        if (_answered && changed > 0 && _answers.length > 0) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (BuildContext context) => Question6View(
                                profile: profile,
                                listBestMatchQuestion: listBestMatchQuestion,
                              ),
                            ),
