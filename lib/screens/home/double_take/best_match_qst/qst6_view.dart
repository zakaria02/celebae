...
import 'qst7_view.dart';

class Question6View extends StatefulWidget {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  Question6View({this.profile, this.listBestMatchQuestion});
  @override
  State<StatefulWidget> createState() {
    return _Question6ViewState(
      profile: profile,
...
class _Question6ViewState extends State<Question6View> {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  _Question6ViewState({this.profile, this.listBestMatchQuestion});
                      ...
                      onPressed: () {
                        ...
                        if (_answered && changed > 0 && _answers.length > 0) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (BuildContext context) => Question7View(
                                profile: profile,
                                listBestMatchQuestion: listBestMatchQuestion,
                              ),
                            ),
