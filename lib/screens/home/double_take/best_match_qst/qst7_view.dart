...
import 'qst8_view.dart';

class Question7View extends StatefulWidget {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  Question7View({this.profile, this.listBestMatchQuestion});
  @override
  State<StatefulWidget> createState() {
    return _Question7ViewState(
      profile: profile,
...
enum SingingCharacter { yes, no, rarely }

class _Question7ViewState extends State<Question7View> {
  List<BestMatchQuestion> listBestMatchQuestion = new List<BestMatchQuestion>();
  Profile profile;
  _Question7ViewState({this.profile, this.listBestMatchQuestion});
  ...
  SingingCharacter sc;
  bool _answered = false, _yes = false, _no = false, _rarely = false;
                      ...
                      onPressed: () {
                        ...
                        if (_answered && changed > 0 && _answers.length > 0) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (BuildContext context) => Question8View(
                                profile: profile,
                                listBestMatchQuestion: listBestMatchQuestion,
                              ),
                            ),
